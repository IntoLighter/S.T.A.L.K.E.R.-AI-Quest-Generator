...
class PromptTab(Tab):
    ...
    def save(self) -> None:
        ...
        self.preferences_config.custom_concept_prompt = self.concept_editor.custom_content

        self.preferences_config.metadata_prompt_source = self.metadata_editor.source
        self.preferences_config.custom_metadata_prompt = self.metadata_editor.custom_content
